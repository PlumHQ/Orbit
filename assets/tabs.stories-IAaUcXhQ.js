import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as d}from"./index-DpTt3J-R.js";import{u as H,a as M,c as V,P as G}from"./index-PdevSJdQ.js";import{c as B}from"./index-bX3F6qy8.js";import{u as k,c as S,R as O,I as W}from"./index-ZRahkmzL.js";import"./index-D9ZhQrDp.js";import{c as K}from"./index-CxBDjkVw.js";import{c as C}from"./utilities-DX5EtrsU.js";import{C as J}from"./index-FunEQ59o.js";import{O as Q,I,H as _}from"./index-obMssGqU.js";import"./index-B5ODnmFs.js";import"./clsx-B-dksMZM.js";import"./bundle-mjs-C8PyMnuF.js";import"./index-B8k91cqS.js";/* empty css              *//* empty css               */var U=["a","button","div","form","h2","h3","img","input","label","li","nav","ol","p","select","span","svg","ul"],N=U.reduce((a,t)=>{const s=K(`Primitive.${t}`),r=d.forwardRef((i,o)=>{const{asChild:n,...c}=i,l=n?s:t;return typeof window<"u"&&(window[Symbol.for("radix-ui")]=!0),e.jsx(l,{...c,ref:o})});return r.displayName=`Primitive.${t}`,{...a,[t]:r}},{}),j="Tabs",[X,Te]=B(j,[S]),A=S(),[Y,w]=X(j),q=d.forwardRef((a,t)=>{const{__scopeTabs:s,value:r,onValueChange:i,defaultValue:o,orientation:n="horizontal",dir:c,activationMode:l="automatic",...b}=a,u=k(c),[m,g]=H({prop:r,onChange:i,defaultProp:o??"",caller:j});return e.jsx(Y,{scope:s,baseId:M(),value:m,onValueChange:g,orientation:n,dir:u,activationMode:l,children:e.jsx(N.div,{dir:u,"data-orientation":n,...b,ref:t})})});q.displayName=j;var $="TabsList",R=d.forwardRef((a,t)=>{const{__scopeTabs:s,loop:r=!0,...i}=a,o=w($,s),n=A(s);return e.jsx(O,{asChild:!0,...n,orientation:o.orientation,dir:o.dir,loop:r,children:e.jsx(N.div,{role:"tablist","aria-orientation":o.orientation,...i,ref:t})})});R.displayName=$;var E="TabsTrigger",P=d.forwardRef((a,t)=>{const{__scopeTabs:s,value:r,disabled:i=!1,...o}=a,n=w(E,s),c=A(s),l=D(n.baseId,r),b=F(n.baseId,r),u=r===n.value;return e.jsx(W,{asChild:!0,...c,focusable:!i,active:u,children:e.jsx(N.button,{type:"button",role:"tab","aria-selected":u,"aria-controls":b,"data-state":u?"active":"inactive","data-disabled":i?"":void 0,disabled:i,id:l,...o,ref:t,onMouseDown:V(a.onMouseDown,m=>{!i&&m.button===0&&m.ctrlKey===!1?n.onValueChange(r):m.preventDefault()}),onKeyDown:V(a.onKeyDown,m=>{[" ","Enter"].includes(m.key)&&n.onValueChange(r)}),onFocus:V(a.onFocus,()=>{const m=n.activationMode!=="manual";!u&&!i&&m&&n.onValueChange(r)})})})});P.displayName=E;var L="TabsContent",z=d.forwardRef((a,t)=>{const{__scopeTabs:s,value:r,forceMount:i,children:o,...n}=a,c=w(L,s),l=D(c.baseId,r),b=F(c.baseId,r),u=r===c.value,m=d.useRef(u);return d.useEffect(()=>{const g=requestAnimationFrame(()=>m.current=!1);return()=>cancelAnimationFrame(g)},[]),e.jsx(G,{present:i||u,children:({present:g})=>e.jsx(N.div,{"data-state":u?"active":"inactive","data-orientation":c.orientation,role:"tabpanel","aria-labelledby":l,hidden:!g,id:b,tabIndex:0,...n,ref:t,style:{...a.style,animationDuration:m.current?"0s":void 0},children:g&&o})})});z.displayName=L;function D(a,t){return`${a}-trigger-${t}`}function F(a,t){return`${a}-content-${t}`}var Z=q,ee=R,ae=P,te=z;function h({className:a,onValueChange:t,orientation:s="horizontal",children:r,selectedValue:i,styleVariant:o="gray",verticalTabHeader:n="",...c}){return e.jsx(Z,{"data-slot":"tabs",...c,className:C("flex",s==="vertical"?"flex-row-reverse":"flex-col",a),value:i,children:d.Children.map(r,l=>d.isValidElement(l)?d.cloneElement(l,{onValueChange:t,selectedValue:i,styleVariant:o,orientation:s,verticalTabHeader:n}):l)})}function v({className:a,styleVariant:t,orientation:s,children:r,onValueChange:i,selectedValue:o,verticalTabHeader:n,showHeaderIcon:c,...l}){return e.jsxs("div",{children:[n&&e.jsxs("div",{className:`flex items-center justify-start text-interactive-text-${t}-muted font-primary text-base font-medium mb-2 pr-1`,children:[c&&e.jsx(Q,{size:"large",className:`fill-surface-icon-${t}-muted mr-1`}),e.jsx("div",{children:n})]}),e.jsx(ee,{"data-slot":"tabs-list",className:C("bg-muted text-muted-foreground",s==="vertical"?`flex flex-col h-fit w-36 items-start justify-start rounded-lg border-l-2 border-interactive-border-${t}-subtle rounded-0.5`:`inline-flex h-9 w-fit items-center justify-center rounded-lg  border-b-2 border-interactive-border-${t}-subtle rounded-0.5`,"",n?"ml-2":"",a),...l,children:d.Children.map(r,(b,u)=>d.isValidElement(b)?d.cloneElement(b,{onValueChange:i,selectedValue:o,styleVariant:t,orientation:s,isLastTab:u===d.Children.count(r)-1}):b)})]})}function p({className:a,name:t,leadingIcon:s,counter:r,value:i,selectedValue:o,styleVariant:n,onValueChange:c,orientation:l,isLastTab:b,...u}){return e.jsx(ae,{value:i,"data-slot":"tabs-trigger",...u,children:e.jsxs("button",{className:`${l==="vertical"?"flex":`${b?"":"mr-4"} pt-1`} focus-visible:plum-focus focus:none rounded-2 font-semibold`,onClick:()=>{c?.(i)},children:[o===i&&l==="vertical"?e.jsx("div",{className:`w-05 bg-interactive-icon-${n}-muted  ml-1-negative rounded-0.5`}):"",e.jsxs("div",{className:C(`flex items-center font-primary text-base font-primary text-interactive-text-${n}-${o===i?"normal":"muted"} 
        hover:text-interactive-text-${n}-subtle 
        focus-visible:plum-focus ${l==="vertical"?`m-1 ml-${o===i?"45":"4"}`:`mb-${o===i?"25":"2"}`} `,`${l==="horizontal"?"mb-2":""}`),children:[s&&d.createElement(s,{size:"large",className:`mr-1 fill-surface-icon-${n}-${n==="beige"?"muted":"subtle"}`}),e.jsx("div",{children:t}),r&&e.jsx("div",{className:"ml-1",children:e.jsx(J,{size:"medium",styleVariant:n==="beige"?"information":"neutral",value:r})})]}),o===i&&l==="horizontal"?e.jsx("div",{className:`h-05 bg-interactive-icon-${n}-muted mb-1-negative rounded-0.5`}):""]})})}function f({className:a,...t}){return e.jsx(te,{"data-slot":"tabs-content",className:C("flex-1 outline-none",a),...t})}try{h.displayName="Tabs",h.__docgenInfo={description:"",displayName:"Tabs",props:{onValueChange:{defaultValue:null,description:"A function called when a new tab is selected",name:"onValueChange",required:!1,type:{name:"((value: string) => void) | undefined"}},selectedValue:{defaultValue:null,description:"",name:"selectedValue",required:!1,type:{name:"string | undefined"}},styleVariant:{defaultValue:{value:"gray"},description:"",name:"styleVariant",required:!1,type:{name:"string | undefined"}},verticalTabHeader:{defaultValue:{value:""},description:"",name:"verticalTabHeader",required:!1,type:{name:"string | undefined"}},orientation:{defaultValue:{value:"horizontal"},description:`The orientation the tabs are layed out.
