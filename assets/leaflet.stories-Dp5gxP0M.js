import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{L as t}from"./component-BB1ZI6DO.js";import{R as i,I as e}from"./index-BdKfWn55.js";import"./index-DpTt3J-R.js";import"./index-Dp3B9jqt.js";import"./clsx-B-dksMZM.js";import"./utilities-CP3_-lCt.js";/* empty css              *//* empty css               */const C={title:"Design System/Leaflet",component:t,parameters:{layout:"centered",docs:{description:{component:"A leaflet component for displaying informational cards or callouts."}}},tags:["autodocs"],argTypes:{style:{control:{type:"select"},options:["positive","information","notice"],description:"The style of the leaflet"},size:{control:{type:"select"},options:["small","medium","large"],description:"The size of the leaflet"},leadingText:{control:{type:"text"},description:"The leading text of the leaflet"},trailingText:{control:{type:"text"},description:"The trailing text of the leaflet"}},args:{style:"information",size:"medium",leadingText:"Leaflet Text",trailingText:"Additional info",onClick:()=>console.log("Leaflet clicked")}},o={args:{style:"information",size:"medium",leadingIcon:e,trailingIcon:i,leadingText:"Information",trailingText:"Additional details",width:"800"}},a={args:{style:"positive",size:"medium",leadingIcon:e,trailingIcon:i,leadingText:"Success",trailingText:"Operation completed",width:"800"}},r={args:{style:"notice",size:"medium",leadingIcon:e,trailingIcon:i,leadingText:"Notice",trailingText:"Please review",width:"800"}},s={args:{style:"information",size:"medium",leadingText:"With Icon",trailingText:"Icon included",leadingIcon:e,width:"800"}},l={render:N=>n.jsxs("div",{className:"space-y-4 w-full max-w-md",children:[n.jsx(t,{style:"information",size:"medium",leadingIcon:e,trailingIcon:i,leadingText:"Medium",trailingText:"Medium size",width:"800"}),n.jsx(t,{style:"information",size:"large",leadingIcon:e,trailingIcon:i,leadingText:"Large",trailingText:"Large size",width:"800"})]}),args:{}},c={render:N=>n.jsxs("div",{className:"space-y-4 w-full max-w-md",children:[n.jsx(t,{style:"positive",size:"medium",leadingIcon:e,trailingIcon:i,leadingText:"Positive",trailingText:"Success message",width:"800"}),n.jsx(t,{style:"information",size:"medium",leadingIcon:e,trailingIcon:i,leadingText:"Information",trailingText:"Info message",width:"800"}),n.jsx(t,{style:"notice",size:"medium",leadingIcon:e,trailingIcon:i,leadingText:"Notice",trailingText:"Important notice",width:"800"})]}),args:{}};var d,g,m;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    style: 'information',
    size: 'medium',
...
}`,...(m=(g=o.parameters)==null?void 0:g.docs)==null?void 0:m.source}}};var I,p,x;a.parameters={...a.parameters,docs:{...(I=a.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    style: 'positive',
    size: 'medium',
    leadingIcon: InfoIcon,
...
}`,...(x=(p=a.parameters)==null?void 0:p.docs)==null?void 0:x.source}}};var f,u,T;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    style: 'notice',
    size: 'medium',
    leadingIcon: InfoIcon,
...
}`,...(T=(u=r.parameters)==null?void 0:u.docs)==null?void 0:T.source}}};var h,w,y;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    style: 'information',
    size: 'medium',
