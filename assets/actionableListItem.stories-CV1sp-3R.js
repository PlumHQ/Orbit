import{j as t}from"./jsx-runtime-BjG_zV1W.js";import{R as P}from"./index-DpTt3J-R.js";import{f as D,g as B,h as _,i as $,R as W,I as c}from"./index-DGR86Cth.js";import{c as Z}from"./index-B8k91cqS.js";import{c as F}from"./utilities-DX5EtrsU.js";import{B as E}from"./component-BiQ_LjZ3.js";import{L as O}from"./component-CiAuhbiN.js";/* empty css              */import{H as i}from"./health-insurance-D3EfjtyX.js";/* empty css               */import"./clsx-B-dksMZM.js";import"./bundle-mjs-C8PyMnuF.js";const a=({variant:e,size:r,behaviour:m,leadingAsset:f,primaryText:h,secondaryTexts:u,tertiaryText:x,callToAction:p,badgeText:T,badgeSize:b,badgeVariant:A,badgeStyle:I,leafletLeadingIcon:z=c,leafletLeadingText:L="",leafletTrailingIcon:C=W,leafletTrailingText:w="",leafletStyle:S="positive",showRightArrowIcon:k=!0,showNotification:j=!0,onNotificationClick:V=()=>{},onItemClick:N=()=>{}})=>{const R=f,[y,q]=P.useState(!1),M=Z(`flex cursor-pointer relative z-1 font-primary justify-between w-1405 ${e==="secondary"?"bg-surface-background-peach-subtle":"bg-interactive-background-white-normal"} hover:bg-interactive-background-${e==="secondary"?"peach":"gray"}-normal border border-interactive-border-${m==="select"&&y?"primary":"gray"}-normal rounded-4 items-center`,{variants:{size:{medium:"px-5 py-4",large:"px-8 py-6"}},defaultVariants:{size:"medium"}}),H=()=>{m==="select"&&q(g=>!g),N()};return t.jsxs("div",{children:[t.jsxs("div",{className:F(M({size:r})),onClick:H,children:[t.jsxs("div",{className:"flex",children:[t.jsx("div",{className:`flex h-${r==="large"?14:12} w-${r==="large"?14:12} mr-3`,children:t.jsx(R,{})}),t.jsxs("div",{children:[t.jsx("div",{className:`text-interactive-text-${y?"":"gray"}-normal font-semibold text-${r==="large"?"lg":"base"} mb-05`,children:h}),t.jsx("div",{className:"flex items-center mb-05",children:u&&u.map((g,v)=>t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"text-interactive-text-gray-subtle font-normal text-base mr-05",children:g},v),v<u.length-1&&t.jsx(D,{size:"medium",className:"fill-surface-icon-gray-muted mr-05"})]}))}),r==="large"&&x&&t.jsx("div",{className:"text-interactive-text-gray-subtle font-normal text-sm",children:x})]})]}),t.jsx("div",{className:"flex items-center cursor-pointer",children:m==="select"&&e==="primary"?y?t.jsx(B,{size:"extraLarge",className:"fill-interactive-icon-destructive-normal"}):t.jsx(_,{size:"extraLarge",className:"fill-interactive-icon-gray-subtle"}):t.jsxs("div",{className:"flex items-center gap-2",children:[T?t.jsx(E,{value:T,size:b||"medium",variant:A||"primary",styleVariant:I||"neutral"}):p?t.jsx("div",{className:"text-interactive-text-beige-subtle text-sm font-medium",children:p}):"",k&&t.jsx($,{size:"extraLarge",className:"fill-interactive-icon-gray-subtle"})]})})]}),e==="primary"&&j&&t.jsx("div",{className:`mt-negative-${r==="large"?6:35}`,children:t.jsx(O,{size:r,style:S,leadingIcon:z,leadingText:L,trailingIcon:C,trailingText:w,onClick:V})})]})};try{a.displayName="ActionableListItem",a.__docgenInfo={description:"",displayName:"ActionableListItem",props:{variant:{defaultValue:null,description:"",name:"variant",required:!0,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'}]}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"large"'},{value:'"medium"'}]}},behaviour:{defaultValue:null,description:"",name:"behaviour",required:!0,type:{name:"enum",value:[{value:'"select"'},{value:'"click"'}]}},leadingAsset:{defaultValue:null,description:"",name:"leadingAsset",required:!0,type:{name:"FC<{}>"}},primaryText:{defaultValue:null,description:"",name:"primaryText",required:!0,type:{name:"string"}},secondaryTexts:{defaultValue:null,description:"",name:"secondaryTexts",required:!1,type:{name:"string[] | undefined"}},tertiaryText:{defaultValue:null,description:"",name:"tertiaryText",required:!0,type:{name:"string"}},badgeText:{defaultValue:null,description:"",name:"badgeText",required:!1,type:{name:"string | undefined"}},badgeSize:{defaultValue:null,description:"",name:"badgeSize",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"large"'},{value:'"medium"'},{value:'"small"'}]}},badgeVariant:{defaultValue:null,description:"",name:"badgeVariant",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'}]}},badgeStyle:{defaultValue:null,description:"",name:"badgeStyle",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"positive"'},{value:'"negative"'},{value:'"information"'},{value:'"notice"'},{value:'"neutral"'}]}},callToAction:{defaultValue:null,description:"",name:"callToAction",required:!1,type:{name:"string | undefined"}},leafletLeadingIcon:{defaultValue:{value:`({
  color = '',
  className,
  size = 'large',
  ...props
...
}`,...d.parameters?.docs?.source}}};const se=["DefaultWithBadge","DefaultWithCallToAction","DefaultWithSelectable","AllSizes","AllVariants"];export{o as AllSizes,d as AllVariants,n as DefaultWithBadge,s as DefaultWithCallToAction,l as DefaultWithSelectable,se as __namedExportsOrder,ne as default};
