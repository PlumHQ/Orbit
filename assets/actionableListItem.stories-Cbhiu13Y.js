import{j as t}from"./jsx-runtime-BjG_zV1W.js";import{R as U}from"./index-DpTt3J-R.js";import{c as X,d as Y,e as ee,f as te,R as ae,I as d}from"./index-BdKfWn55.js";import{c as ie}from"./index-Dp3B9jqt.js";import{c as re}from"./utilities-CP3_-lCt.js";import{B as ne}from"./component-Bri54jXR.js";import{L as se}from"./component-BB1ZI6DO.js";/* empty css              */import{H as i}from"./health-insurance-D3EfjtyX.js";/* empty css               */import"./clsx-B-dksMZM.js";const a=({variant:e,size:r,behaviour:m,leadingAsset:q,primaryText:R,secondaryTexts:u,tertiaryText:x,callToAction:p,badgeText:v,badgeSize:H,badgeVariant:D,badgeStyle:P,leafletLeadingIcon:_=d,leafletLeadingText:B="",leafletTrailingIcon:$=ae,leafletTrailingText:W="",leafletStyle:Z="positive",showRightArrowIcon:F=!0,onNotificationClick:E=()=>{},onItemClick:O=()=>{}})=>{const G=q,[y,J]=U.useState(!1),K=ie(`flex cursor-pointer relative z-1 font-primary justify-between w-full ${e==="secondary"?"bg-surface-background-peach-subtle":"bg-interactive-background-white-normal"} hover:bg-interactive-background-${e==="secondary"?"peach":"gray"}-normal border border-interactive-border-${m==="select"&&y?"primary":"gray"}-normal rounded-4 items-center`,{variants:{size:{medium:"px-5 py-4",large:"px-8 py-6"}},defaultVariants:{size:"medium"}}),Q=()=>{m==="select"&&J(g=>!g),O()};return t.jsxs("div",{children:[t.jsxs("div",{className:re(K({size:r})),onClick:Q,children:[t.jsxs("div",{className:"flex",children:[t.jsx("div",{className:`flex h-${r==="large"?14:12} w-${r==="large"?14:12} mr-3`,children:t.jsx(G,{})}),t.jsxs("div",{children:[t.jsx("div",{className:`text-interactive-text-${y?"":"gray"}-normal font-semibold text-${r==="large"?"lg":"base"} mb-05`,children:R}),t.jsx("div",{className:"flex items-center mb-05",children:u&&u.map((g,T)=>t.jsxs(t.Fragment,{children:[t.jsx("div",{className:"text-interactive-text-gray-subtle font-normal text-base mr-05",children:g},T),T<u.length-1&&t.jsx(X,{size:"medium",className:"fill-surface-icon-gray-muted mr-05"})]}))}),r==="large"&&x&&t.jsx("div",{className:"text-interactive-text-gray-subtle font-normal text-sm",children:x})]})]}),t.jsx("div",{className:"flex items-center cursor-pointer",children:m==="select"&&e==="primary"?y?t.jsx(Y,{size:"extraLarge",className:"fill-interactive-icon-destructive-normal"}):t.jsx(ee,{size:"extraLarge",className:"fill-interactive-icon-gray-subtle"}):t.jsxs("div",{className:"flex items-center gap-2",children:[v?t.jsx(ne,{value:v,size:H||"medium",variant:D||"primary",styleVariant:P||"neutral"}):p?t.jsx("div",{className:"text-interactive-text-beige-subtle text-sm font-medium",children:p}):"",F&&t.jsx(te,{size:"extraLarge",className:"fill-interactive-icon-gray-subtle"})]})})]}),e==="primary"&&t.jsx("div",{className:`mt-negative-${r==="large"?6:35}`,children:t.jsx(se,{size:r,style:Z,leadingIcon:_,leadingText:B,trailingIcon:$,trailingText:W,onClick:E})})]})};try{a.displayName="ActionableListItem",a.__docgenInfo={description:"",displayName:"ActionableListItem",props:{variant:{defaultValue:null,description:"",name:"variant",required:!0,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'}]}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"medium"'},{value:'"large"'}]}},behaviour:{defaultValue:null,description:"",name:"behaviour",required:!0,type:{name:"enum",value:[{value:'"select"'},{value:'"click"'}]}},leadingAsset:{defaultValue:null,description:"",name:"leadingAsset",required:!0,type:{name:"FC<{}>"}},primaryText:{defaultValue:null,description:"",name:"primaryText",required:!0,type:{name:"string"}},secondaryTexts:{defaultValue:null,description:"",name:"secondaryTexts",required:!1,type:{name:"string[] | undefined"}},tertiaryText:{defaultValue:null,description:"",name:"tertiaryText",required:!0,type:{name:"string"}},badgeText:{defaultValue:null,description:"",name:"badgeText",required:!1,type:{name:"string | undefined"}},badgeSize:{defaultValue:null,description:"",name:"badgeSize",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"medium"'},{value:'"large"'},{value:'"small"'}]}},badgeVariant:{defaultValue:null,description:"",name:"badgeVariant",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'}]}},badgeStyle:{defaultValue:null,description:"",name:"badgeStyle",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"positive"'},{value:'"negative"'},{value:'"neutral"'},{value:'"notice"'},{value:'"information"'}]}},callToAction:{defaultValue:null,description:"",name:"callToAction",required:!1,type:{name:"string | undefined"}},leafletLeadingIcon:{defaultValue:{value:`({
  color = '',
  className,
  size = 'large',
  ...props
...
}`,...(b=(h=n.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var I,A,z;s.parameters={...s.parameters,docs:{...(I=s.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => <div className="w-150 max-w-md">
            <ActionableListItem {...args} size={args.size} primaryText={args.primaryText} secondaryTexts={args.secondaryTexts} leadingAsset={args.leadingAsset} tertiaryText={args.tertiaryText} variant={args.variant} behaviour={args.behaviour} />
        </div>,
  args: {
...
}`,...(z=(A=s.parameters)==null?void 0:A.docs)==null?void 0:z.source}}};var C,L,w;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: args => <div className="w-150 max-w-md">
            <ActionableListItem {...args} size={args.size} primaryText={args.primaryText} secondaryTexts={args.secondaryTexts} leadingAsset={args.leadingAsset} tertiaryText={args.tertiaryText} variant={args.variant} behaviour={args.behaviour} />
        </div>,
  args: {
...
}`,...(w=(L=l.parameters)==null?void 0:L.docs)==null?void 0:w.source}}};var S,k,j;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...(j=(k=o.parameters)==null?void 0:k.docs)==null?void 0:j.source}}};var N,V,M;c.parameters={...c.parameters,docs:{...(N=c.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => <div className="space-y-2 w-150 max-w-md">
...
}`,...(M=(V=c.parameters)==null?void 0:V.docs)==null?void 0:M.source}}};const fe=["DefaultWithBadge","DefaultWithCallToAction","DefaultWithSelectable","AllSizes","AllVariants"];export{o as AllSizes,c as AllVariants,n as DefaultWithBadge,s as DefaultWithCallToAction,l as DefaultWithSelectable,fe as __namedExportsOrder,Te as default};
