import{j as l}from"./jsx-runtime-BjG_zV1W.js";import{R as u}from"./index-DpTt3J-R.js";import{C as d}from"./index-DIjgcm8G.js";import{c}from"./index-B8k91cqS.js";import{c as m}from"./utilities-DX5EtrsU.js";/* empty css               *//* empty css              */const n=({color:e,size:i,disabled:a=!1,icon:r=d,onClick:o=()=>{}})=>{const s=c(`${a?"":`hover:bg-interactive-background-${e}-${e==="white"?"muted":"normal"}`} focus-visible:plum-focus`,{variants:{size:{large:"rounded-15",medium:"rounded-1",small:"rounded-1"}}}),t=`fill-interactive-icon-${e}-${a?"disabled":"normal"}`;return l.jsx(l.Fragment,{children:l.jsx("button",{className:m(s({size:i})),disabled:a,onClick:o,children:u.createElement(r,{className:t,size:i})})})};try{n.displayName="IconButton",n.__docgenInfo={description:"",displayName:"IconButton",props:{color:{defaultValue:null,description:"",name:"color",required:!0,type:{name:"enum",value:[{value:'"beige"'},{value:'"gray"'},{value:'"white"'}]}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"small"'},{value:'"medium"'},{value:'"large"'}]}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean | undefined"}},icon:{defaultValue:{value:`({
  color,
