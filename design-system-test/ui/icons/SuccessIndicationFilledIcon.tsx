...
interface SuccessIndicationIconFilledProps
...
const SuccessIndicationIconFilled: React.FC<
  SuccessIndicationIconFilledProps
> = ({
  color,
...
export default SuccessIndicationIconFilled;
