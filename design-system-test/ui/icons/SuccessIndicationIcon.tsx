...
interface SuccessIndicationIconProps extends React.SVGProps<SVGSVGElement> {
  color?: string;
  className?: string;
  size?: string;
  disabled?: boolean;
...
const SuccessIndicationIcon: React.FC<SuccessIndicationIconProps> = ({
  color,
...
export default SuccessIndicationIcon;
