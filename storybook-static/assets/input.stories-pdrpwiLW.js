import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as s,R as p}from"./index-DpTt3J-R.js";import{L as ae}from"./index-BQZ0aaPO.js";import{w as le,I as L,n as te,b as ie,o as re}from"./index-2-1EQAb5.js";import{I as se}from"./index-Kyk16D5A.js";/* empty css              */import"./index-Dp3B9jqt.js";import"./clsx-B-dksMZM.js";import"./utilities-WNthGydt.js";import"./bundle-mjs-CLJs87Zn.js";/* empty css                *//* empty css               */const l=({label:n,helperLink:$,helperText:K,disabled:f=!1,placeholder:Z,isRequired:m,isOptional:D,helpTextIcon:x=L,showPrefixIcon:h=!1,prefixIcon:g,prefixValue:c,defaultValue:O="",shortcutKey:y,suffixIcon:b,bankLogoIcon:v,showSuffixButton:V,showValidation:P,isValid:C=a=>!0,errorText:W,successText:A,onChange:q=a=>{},onFocus:G=()=>{},onBlur:J=()=>{},size:t,id:Q})=>{const[a,I]=s.useState(O),[i,T]=s.useState(!0),[w,N]=s.useState(!1);s.useEffect(()=>{q(a)},[a,q]);const U=()=>{},X=ne=>{const z=ne.target.value;I(z),T(C(z)),N(!0)},Y=()=>{T(C(a)),w||N(!0)},r=w&&P&&(a||m),j=r?i?A:W:K,ee=`
  ...
  `;return e.jsxs("div",{className:"w-full font-primary",onBlur:J,onFocus:G,children:[e.jsxs("div",{className:"flex justify-between mb-1 px-1",children:[n&&e.jsxs("div",{className:"flex text-sm",children:[e.jsx("div",{className:"text-surface-text-gray-subtle font-semibold",children:n}),m?e.jsx("div",{className:"text-feedback-text-negative-intense ml-05",children:"*"}):D?e.jsx("div",{className:"text-feedback-text-neutral-muted ml-05",children:"(Optional)"}):null]}),$&&e.jsx(ae,{state:"primary",label:"Link",size:t==="medium"?"small":"medium"})]}),e.jsxs("div",{className:ee,children:[h&&p.createElement(g,{size:t,className:"fill-interactive-icon-gray-subtle"}),c&&e.jsx("span",{className:`font-primary text-sm font-normal text-surface-text-gray-subtle ml-${h?3:0}`,children:c}),e.jsx("input",{className:`ml-${c||g?15:0} focus-visible:outline-none placeholder-gray-400 text-surface-text-gray-normal bg-inherit font-normal font-primary text-sm ${V&&a?"w-[calc(100%-24px)]":"w-full"}`,id:Q||"input-field-main",disabled:f,placeholder:Z,value:a,onFocus:U,onChange:X,onBlur:Y}),v&&e.jsx("div",{className:"mr-2",children:e.jsx("img",{src:v,className:"w-4 h-4",alt:"Bank Logo"})}),y&&e.jsxs("div",{className:"flex items-center",children:[e.jsx(le,{size:t==="medium"?"extraSmall":"medium"}),e.jsx("div",{className:"text-surface-text-gray-muted text-xs font-medium overflow-ellipsis ml-05",children:y})]}),b&&e.jsx("div",{className:`${a?"mx-2":"ml-2"}`,children:p.createElement(b,{size:t,className:"fill-interactive-icon-gray-muted"})}),V&&a&&e.jsx(se,{size:t,color:"gray",onClick:()=>I("")})]}),e.jsx("div",{className:"flex justify-between mb-1 px-1",children:j&&e.jsxs("div",{className:"flex items-center",children:[r?i?e.jsx(te,{size:"small",className:"fill-feedback-icon-positive-intense mr-1"}):e.jsx(ie,{size:"small",className:"fill-feedback-icon-negative-intense mr-1"}):x&&p.createElement(x,{size:t==="large"?"medium":"small",className:"fill-feedback-icon-neutral-muted mr-1"}),e.jsx("div",{className:`text-xs font-medium ${r?i?"text-feedback-text-positive-intense":"text-feedback-text-negative-intense":"text-feedback-text-neutral-muted"}`,children:j})]})})]})};try{l.displayName="Input",l.__docgenInfo={description:"",displayName:"Input",props:{label:{defaultValue:null,description:"",name:"label",required:!1,type:{name:"string | undefined"}},helperLink:{defaultValue:null,description:"",name:"helperLink",required:!1,type:{name:"string | undefined"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean | undefined"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"large"'},{value:'"medium"'}]}},helperText:{defaultValue:null,description:"",name:"helperText",required:!1,type:{name:"string | undefined"}},placeholder:{defaultValue:null,description:"",name:"placeholder",required:!1,type:{name:"string | undefined"}},isRequired:{defaultValue:null,description:"",name:"isRequired",required:!1,type:{name:"boolean | undefined"}},isOptional:{defaultValue:null,description:"",name:"isOptional",required:!1,type:{name:"boolean | undefined"}},helpTextIcon:{defaultValue:{value:`({
  color = '',
  className,
  size = 'large',
  ...props
...
}`,...(S=(k=u.parameters)==null?void 0:k.docs)==null?void 0:S.source}}};var B,F,_;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
...
}`,...(_=(F=d.parameters)==null?void 0:F.docs)==null?void 0:_.source}}};var H,M,R;o.parameters={...o.parameters,docs:{...(H=o.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    size: 'medium',
...
}`,...(R=(M=o.parameters)==null?void 0:M.docs)==null?void 0:R.source}}};const Ve=["Default","AllSizes","Disabled"];export{d as AllSizes,u as Default,o as Disabled,Ve as __namedExportsOrder,ve as default};
