import{r as a,R as t}from"./index-DpTt3J-R.js";import{L as Ce}from"./index-C-QsPwmW.js";import{j as Ie,I as Ee,k as Te,E as ke,U as x,l as S}from"./index-C_GYH-13.js";/* empty css              */import"./index-Dp3B9jqt.js";import"./clsx-B-dksMZM.js";import"./utilities-CP3_-lCt.js";/* empty css               */const O=({label:C,helperLink:ne,helperText:re,disabled:I=!1,placeholder:oe,isRequired:D,isOptional:se,helpTextIcon:z=Ee,defaultValue:ie="",prefixIcon:E,showValidation:ce,prefixValue:L="",isValid:M=n=>!0,errorText:ue,successText:de,onChange:T=n=>{},onFocus:pe=()=>{},onBlur:me=()=>{},size:u,id:fe,options:o=[],searchable:c=!1,onSelect:be=()=>{}})=>{const[n,F]=a.useState(ie),[b,R]=a.useState(!0),[_,$]=a.useState(!1),[r,s]=a.useState(!1),[d,k]=a.useState(o),[p,ge]=a.useState(null),[q,i]=a.useState(-1),N=a.useRef(null),H=a.useRef(null);a.useEffect(()=>{T(n)},[n,T]),a.useEffect(()=>{k(o)},[o]),a.useEffect(()=>{if(c&&r){const e=o.filter(l=>l.label.toLowerCase().includes(n.toLowerCase()));k(e)}else k(o)},[n,o,c,r]),a.useEffect(()=>{const e=l=>{N.current&&!N.current.contains(l.target)&&(s(!1),i(-1))};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}},[]);const xe=()=>{pe()},he=e=>{const l=e.target.value;F(l),R(M(l)),$(!0),c&&o.length>0&&s(!0)},ye=()=>{R(M(n)),_||$(!0),me()},ve=()=>{I||o.length===0||(s(!r),i(-1))},B=e=>{ge(e),F(e.label),s(!1),i(-1),be(e),T(e.value)},Ve=e=>{var l;if(o.length!==0)switch(e.key){case"ArrowDown":e.preventDefault(),r?i(m=>m<d.length-1?m+1:0):s(!0);break;case"ArrowUp":e.preventDefault(),r&&i(m=>m>0?m-1:d.length-1);break;case"Enter":e.preventDefault(),r&&q>=0?B(d[q]):r||s(!0);break;case"Escape":e.preventDefault(),s(!1),i(-1),(l=H.current)==null||l.blur();break;case"Tab":s(!1),i(-1);break}},we=p?p.label:n,g=_&&ce&&(n||D),j=g?b?de:ue:re,Se=`
    ...
    ${I?"bg-surface-background-gray-muted cursor-not-allowed":"bg-surface-background-white-normal"}
  ...
  `;return t.createElement("div",{className:"w-full font-primary relative",ref:N},t.createElement("div",{className:"flex justify-between mb-1 px-1"},C&&t.createElement("div",{className:`flex text-${u==="medium"?"xs":"sm"}`},t.createElement("div",{className:"text-surface-text-gray-subtle font-semibold"},C),D?t.createElement("div",{className:"text-feedback-text-negative-intense ml-05"},"*"):se?t.createElement("div",{className:"text-feedback-text-neutral-muted ml-05"},"(Optional)"):null),ne&&t.createElement(Ce,{state:"primary",label:"Link",size:u==="medium"?"small":"medium"})),t.createElement("div",{className:Se,onClick:ve},E&&t.createElement(E,{size:u,className:"fill-interactive-icon-gray-subtle"}),L&&t.createElement("span",{className:`font-primary text-sm font-normal text-surface-text-gray-subtle ml-${E?15:0}`},L),t.createElement("input",{ref:H,className:`ml-15 focus-visible:outline-none placeholder-gray-400 text-surface-text-gray-normal bg-inherit font-normal font-primary text-sm w-full ${c?"":"cursor-pointer"}`,id:fe||"input-field-main",disabled:I,placeholder:oe,value:c?n:we,onFocus:xe,onChange:c?he:void 0,onBlur:ye,onKeyDown:Ve,readOnly:!c}),t.createElement("div",{className:`${n?"mx-2":"ml-2"}`},t.createElement(Ie,{className:`fill-interactive-icon-gray-muted transition-transform duration-200 ${r?"rotate-180":""}`,size:u}))),t.createElement("div",{className:"flex justify-between mb-1 px-1"},j&&t.createElement("div",{className:"flex items-center"},g?b?t.createElement(Te,{size:"small",className:"fill-feedback-icon-positive-intense mr-1"}):t.createElement(ke,{size:"small",className:"fill-feedback-icon-negative-intense mr-1"}):z&&t.createElement(z,{size:u==="large"?"medium":"small",className:"fill-feedback-icon-neutral-muted mr-1"}),t.createElement("div",{className:`text-xs font-medium ${g?b?"text-feedback-text-positive-intense":"text-feedback-text-negative-intense":"text-feedback-text-neutral-muted"}`},j))),r&&d.length>0&&t.createElement("div",{className:"absolute dropdown-shadow z-50 w-full rounded-3 mt-2 bg-surface-background-white-normal rounded-lg max-h-60 overflow-y-auto p-2"},d.map((e,l)=>t.createElement("div",{key:e.value,className:`flex items-center px-15 py-2 cursor-pointer hover:bg-surface-background-gray-subtle transition-colors ${l===q?"bg-surface-background-gray-subtle":""} ${(p==null?void 0:p.value)===e.value?"bg-blue-50 text-blue-700":"text-surface-text-gray-normal"}`,onClick:()=>B(e),onMouseEnter:()=>i(l)},e.icon&&t.createElement("div",{className:"mr-1"},t.createElement(e.icon,{size:"medium",className:"fill-interactive-icon-gray-subtle"})),t.createElement("span",{className:"font-primary text-sm font-medium text-interactive-text-gray-normal"},e.label)))))};try{O.displayName="InputSelect",O.__docgenInfo={description:"",displayName:"InputSelect",props:{label:{defaultValue:null,description:"",name:"label",required:!1,type:{name:"string"}},helperLink:{defaultValue:null,description:"",name:"helperLink",required:!1,type:{name:"string"}},disabled:{defaultValue:{value:"false"},description:"",name:"disabled",required:!1,type:{name:"boolean"}},size:{defaultValue:null,description:"",name:"size",required:!0,type:{name:"enum",value:[{value:'"medium"'},{value:'"large"'}]}},helperText:{defaultValue:null,description:"",name:"helperText",required:!1,type:{name:"string"}},placeholder:{defaultValue:null,description:"",name:"placeholder",required:!1,type:{name:"string"}},isRequired:{defaultValue:null,description:"",name:"isRequired",required:!1,type:{name:"boolean"}},isOptional:{defaultValue:null,description:"",name:"isOptional",required:!1,type:{name:"boolean"}},helpTextIcon:{defaultValue:{value:`({
  color = '',
  className,
  size = 'large',
  ...props
...
}`,...(ee=(Y=V.parameters)==null?void 0:Y.docs)==null?void 0:ee.source}}};var te,ae,le;w.parameters={...w.parameters,docs:{...(te=w.parameters)==null?void 0:te.docs,source:{originalSource:`{
  args: {
    size: 'large',
    placeholder: 'Select',
    label: 'Disabled',
...
}`,...(le=(ae=w.parameters)==null?void 0:ae.docs)==null?void 0:le.source}}};const _e=["Large","Medium","SearchableDropdown","WithValidation","WithDisabled"];export{h as Large,y as Medium,v as SearchableDropdown,w as WithDisabled,V as WithValidation,_e as __namedExportsOrder,Re as default};
