import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{r as t,R as D}from"./index-DpTt3J-R.js";import{L as Ce}from"./index-BQZ0aaPO.js";import{m as Te,I as qe,n as ke,b as je,U as h,o as w}from"./index-2-1EQAb5.js";/* empty css              */import"./index-Dp3B9jqt.js";import"./clsx-B-dksMZM.js";import"./utilities-WNthGydt.js";import"./bundle-mjs-CLJs87Zn.js";/* empty css                *//* empty css               */const O=({label:I,helperLink:re,helperText:se,disabled:C=!1,placeholder:oe,isRequired:z,isOptional:ie,helpTextIcon:E=qe,defaultValue:ce="",prefixIcon:T,showValidation:ue,prefixValue:L="",isValid:M=l=>!0,errorText:de,successText:pe,onChange:q=l=>{},onFocus:me=()=>{},onBlur:fe=()=>{},size:u,id:xe,options:s=[],searchable:c=!1,onSelect:be=()=>{}})=>{const[l,R]=t.useState(ce),[x,F]=t.useState(!0),[_,$]=t.useState(!1),[r,o]=t.useState(!1),[d,k]=t.useState(s),[p,he]=t.useState(null),[j,i]=t.useState(-1),N=t.useRef(null),H=t.useRef(null);t.useEffect(()=>{q(l)},[l,q]),t.useEffect(()=>{k(s)},[s]),t.useEffect(()=>{if(c&&r){const e=s.filter(n=>n.label.toLowerCase().includes(l.toLowerCase()));k(e)}else k(s)},[l,s,c,r]),t.useEffect(()=>{const e=n=>{N.current&&!N.current.contains(n.target)&&(o(!1),i(-1))};return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}},[]);const ge=()=>{me()},ye=e=>{const n=e.target.value;R(n),F(M(n)),$(!0),c&&s.length>0&&o(!0)},ve=()=>{F(M(l)),_||$(!0),fe()},Ve=()=>{C||s.length===0||(o(!r),i(-1))},B=e=>{he(e),R(e.label),o(!1),i(-1),be(e),q(e.value)},Se=e=>{var n;if(s.length!==0)switch(e.key){case"ArrowDown":e.preventDefault(),r?i(m=>m<d.length-1?m+1:0):o(!0);break;case"ArrowUp":e.preventDefault(),r&&i(m=>m>0?m-1:d.length-1);break;case"Enter":e.preventDefault(),r&&j>=0?B(d[j]):r||o(!0);break;case"Escape":e.preventDefault(),o(!1),i(-1),(n=H.current)==null||n.blur();break;case"Tab":o(!1),i(-1);break}},we=p?p.label:l,b=_&&ue&&(l||z),W=b?x?pe:de:se,Ie=`
...
}`,...(le=(ne=S.parameters)==null?void 0:ne.docs)==null?void 0:le.source}}};const Be=["Large","Medium","SearchableDropdown","WithValidation","WithDisabled"];export{g as Large,y as Medium,v as SearchableDropdown,S as WithDisabled,V as WithValidation,Be as __namedExportsOrder,He as default};
